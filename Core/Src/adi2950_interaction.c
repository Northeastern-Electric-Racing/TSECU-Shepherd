...
void count_hv_plate_pec_errors(cell_asic_2950 *ic)
{
	...
	if (pec_error_count > 0U) {
		...
		send_hv_plate_pec_errors(
			ic->cccrc.sid2950_pec > 0U, ic->cccrc.comm_pec > 0U,
			ic->cccrc.stat_pec > 0U, ic->cccrc.flag_pec > 0U,
			ic->cccrc.aux_pec > 0U, ic->cccrc.avgivbat_pec > 0U,
			ic->cccrc.avgvbat_pec > 0U, ic->cccrc.avgcr_pec > 0U,
			ic->cccrc.oc_pec > 0U, ic->cccrc.ivbat_pec > 0U,
			ic->cccrc.vbat_pec > 0U, ic->cccrc.cr_pec > 0U,
			ic->cccrc.cfgr_pec > 0U, ic->cccrc.rvr_pec > 0U,
			ic->cccrc.vr_pec > 0U);
	}
